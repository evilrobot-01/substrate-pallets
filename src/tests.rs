...
fn add_liquidity_ensures_signed() {
    new_test_ext().execute_with(|| {
        assert_noop!(
            DEX::add_liquidity(RuntimeOrigin::none(), 0, ASSET_0, 0, ASSET_1, DEADLINE),
...
fn add_liquidity_ensure_assets_unique() {
    new_test_ext().execute_with(|| {
        assert_noop!(
            DEX::add_liquidity(RuntimeOrigin::signed(LP), 0, ASSET_0, 0, ASSET_0, DEADLINE),
...
fn adds_more_liquidity() {
    new_test_ext().execute_with(|| {
        ...
        assert_ok!(DEX::add_liquidity(
            RuntimeOrigin::signed(ANOTHER_LP),
            2 * UNITS,
            ASSET_0,
            1 * UNITS,
            ASSET_1,
...
fn remove_liquidity_ensures_signed() {
    new_test_ext().execute_with(|| {
        assert_noop!(
            DEX::remove_liquidity(RuntimeOrigin::none(), 0, ASSET_0, ASSET_1, DEADLINE),
            DispatchError::BadOrigin
        );
    });
}
...
fn remove_liquidity_ensure_assets_unique() {
    new_test_ext().execute_with(|| {
        assert_noop!(
            DEX::remove_liquidity(RuntimeOrigin::signed(LP), 0, ASSET_0, ASSET_0, DEADLINE),
            Error::<Test>::IdenticalAssets
        );
    });
}
...
fn remove_liquidity_ensure_amount_valid() {
    new_test_ext().execute_with(|| {
        assert_noop!(
            DEX::remove_liquidity(RuntimeOrigin::signed(LP), 0, ASSET_0, ASSET_1, DEADLINE),
            Error::<Test>::InvalidAmount
        );
    });
}
...
fn swap_ensures_signed() {
    new_test_ext().execute_with(|| {
        assert_noop!(
            DEX::swap(RuntimeOrigin::none(), 0, ASSET_0, ASSET_1, DEADLINE),
            DispatchError::BadOrigin
        );
    });
}
...
fn swap_ensure_amount_valid() {
    new_test_ext().execute_with(|| {
        assert_noop!(
            DEX::swap(RuntimeOrigin::signed(BUYER), 0, ASSET_0, ASSET_1, DEADLINE),
            Error::<Test>::InvalidAmount
        );
    });
}
...
fn price_invalid_pool() {
    new_test_ext().execute_with(|| {
        assert_noop!(
            DEX::price(5 * UNITS, ASSET_0, ASSET_1),
            Error::<Test>::NoPool
        );
    });
}
